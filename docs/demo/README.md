...
**[▶ English walkthrough · 3:40](pilot-guided-walkthrough.en.mp4)** · [Direct download](https://github.com/Beeeeeeelle/review-evidence-workflow/releases/download/v1.2.0/pilot-guided-walkthrough.en.mp4) · [中文 · 3:36](README.zh-CN.md)

These are captures of Belle's actual **Pilot full-text coding** interface, using real project proposals and corresponding source PDFs. Both language editions have 16 chapters and 35 guided beats, with independently timed narration, labels and captions. Orange circles identify controls; teal arrows connect citations to source text; editorial close-ups make small controls legible. Yellow quotation highlights come from the functioning reader.

New to the overall process? Start with the **[five-minute introduction to both skills](../intro/README.md)**, then use this tour for individual workbench controls.

![English guidance connects the coding evidence to the actual source](guided-preview.en.jpg)
...
To use the chapter player locally, run `python3 docs/demo/serve.py --port 8940` from the repository root, then open <http://127.0.0.1:8940/?video=pilot&lang=en>. The same player switches topic and language.
...
[English transcript](TRANSCRIPT.en.md) · [English captions](pilot-guided-walkthrough.en.srt) · [English chapters](chapters.en.json) · [中文解说全文](TRANSCRIPT.zh-CN.md)
